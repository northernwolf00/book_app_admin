...
import 'package:book_app_admin/Admin/edit_news.dart';
import 'package:book_app_admin/Admin/login_firebase.dart';
import 'add_book_screen.dart'; // Import your AddNewsScreen
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => EditBooksScreen(
                                newsId: newsId,
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                                content: Text('Books deleted successfully.')),
                          );
                        },
                      ),
                    ],
